  ...
  class Client
    ...
    def raise_version1_initialize_error!(object)
      raise InitializationError,
        "Some code tries to initialize SavonV2 with the #{object.inspect} (#{object.class}) \n" \
        "SavonV2 2 expects a Hash of options for creating a new client and executing requests.\n" \
        "Please read the updated documentation for version 2: http://savon_v2rb.com/version2.html"
    end

    def raise_initialization_error!
      raise InitializationError,
            "Expected either a WSDL document or the SOAP endpoint and target namespace options.\n\n" \
            "SavonV2.client(wsdl: '/Users/me/project/service.wsdl')                              # to use a local WSDL document\n" \
            "SavonV2.client(wsdl: 'http://example.com?wsdl')                                     # to use a remote WSDL document\n" \
            "SavonV2.client(endpoint: 'http://example.com', namespace: 'http://v1.example.com')  # if you don't have a WSDL document"
    end
