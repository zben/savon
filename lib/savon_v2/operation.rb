...
require "savon_v2/builder"
require "savon_v2/response"
require "savon_v2/request_logger"
...
module SavonV2
  class Operation
    ...
    def multipart_supported?
      ...
      if SavonV2.const_defined? :Multipart
        true
      else
        raise 'Unable to find SavonV2::Multipart. Make sure the savon_v2-multipart gem is installed and loaded.'
      end
    end
