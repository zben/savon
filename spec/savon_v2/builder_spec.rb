...
describe SavonV2::Builder do

  subject(:builder) { SavonV2::Builder.new(:authenticate, wsdl, globals, locals) }
  ...
  describe "#to_s" do
    ...
    it "includes a message tag created by GyokuV1 if both option and WSDL are missing" do
      ...
      builder = SavonV2::Builder.new(:authenticate, no_wsdl, globals, locals)
    ...
    describe "#wsse_signature" do
      ...
      let(:globals)     { SavonV2::GlobalOptions.new(wsse_signature: signature) }
